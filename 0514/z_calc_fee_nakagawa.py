...
#結果を表示
print("子供料金　：{0}人 * 500 = {1} 円". format(children, children_price), end = "")
print("通常料金　：{0}人 * 1000 = {1} 円". format(normal, normal_price), end = "")
print("年配者料金：{0}人 * 700 = {1} 円". format(elder, elder_price), end = "")
print("合計　　　：{0}人 {1} 円". format(total_num, total_price), end = "")