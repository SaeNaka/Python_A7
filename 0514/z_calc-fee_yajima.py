...
# 結果を表示
print(f"子供料金：{children}人 × 500 = {children_price}円")
print(f"通常料金：{normal}人 × 1000 = {normal_price}円")
print(f"年配者料金：{elder}人 × 700 = {elder_price}円")
print(f"合計：{total_num}人 {total_price:.0f}円")